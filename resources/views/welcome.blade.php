...
<head>
    ...
    <title>Thế Giới Máy Xây Dựng - Cung Cấp Máy Xúc Cao Cấp</title>
...
<body class="antialiased bg-gray-50 text-gray-900 font-sans selection:bg-brand-500 selection:text-white">
            ...
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <a href="/" class="flex items-center gap-3 group">
                        <div class="w-10 h-10 bg-brand-500 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-brand-500/30 group-hover:scale-105 transition-transform">
                            MX
                        </div>
                        <span class="font-bold text-2xl tracking-tight text-gray-900 group-hover:text-brand-600 transition-colors">Tâm Phúc<span class="text-brand-500">Group</span></span>
                    </a>
                </div>
                <div class="flex items-center gap-6">
                    <a href="#products" class="text-gray-600 hover:text-brand-600 font-medium transition-colors">Sản Phẩm</a>
                    <a href="#about" class="text-gray-600 hover:text-brand-600 font-medium transition-colors">Về Chúng Tôi</a>
                    <a href="/admin" class="bg-gray-900 hover:bg-brand-600 text-white px-5 py-2.5 rounded-full font-medium transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                        Đăng Nhập Admin
                    </a>
                </div>
            </div>
    ...
    <div class="relative bg-white overflow-hidden">
                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <div class="mt-8 sm:flex sm:justify-center lg:justify-start gap-4">
                            <div class="rounded-full shadow-lg">
                                <a href="#products" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-brand-600 hover:bg-brand-500 transition-colors md:py-4 md:text-lg md:px-10 shadow-brand-500/30">
                                    Xem Sản Phẩm
                                </a>
                            </div>
                            <div class="mt-3 sm:mt-0">
                                <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-gray-300 text-base font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50 transition-colors md:py-4 md:text-lg md:px-10">
                                    Liên Hệ Tư Vấn
                                </a>
                            </div>
                        </div>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full clip-path-polygon" src="https://images.unsplash.com/photo-1541888081-36b0ce39e144?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Excavator">
        </div>
    </div>
                ...
                @forelse($products as $product)
                    <div class="group relative bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-1">
                        <div class="w-full min-h-64 bg-gray-200 aspect-w-1 aspect-h-1 overflow-hidden lg:h-64 lg:aspect-none">
                            @if($product->image)
                                <img src="{{ Storage::url($product->image) }}" alt="{{ $product->name }}" class="w-full h-full object-center object-cover group-hover:scale-105 transition-transform duration-500">
                            @else
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8 xl:col-span-1">
                    <a href="/" class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-brand-500 rounded-lg flex items-center justify-center text-white font-bold text-xl">MX</div>
                        <span class="font-bold text-2xl tracking-tight text-white">Tâm Phúc<span class="text-brand-500">Group</span></span>
                    </a>
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                <li><a href="#" class="text-base text-gray-400 hover:text-white transition-colors">Máy Xúc Đào</a></li>
                                <li><a href="#" class="text-base text-gray-400 hover:text-white transition-colors">Máy Xúc Lật</a></li>
                                <li><a href="#" class="text-base text-gray-400 hover:text-white transition-colors">Máy Ủi</a></li>
            ...
            <div class="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="mt-4 md:mt-0 flex gap-4">
                    <a href="/admin" class="text-gray-500 hover:text-white text-sm transition-colors">Truy cập Quản Trị Viên (Admin)</a>
                </div>
            </div>
        </div>
    </footer>
